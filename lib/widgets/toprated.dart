  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          modified_text(text: "Top Rated Movie", color: Colors.white, size: 26),
          SizedBox(height: 10,),
          Container(
            height: 270,
              ...
              child:Container(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      child: modified_text(text: toprated[index]['title']!=null?toprated[index]['title']:'Loading',color: Colors.white,size: 14,),
                    )
                  ],
                ),
              ),
